...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center text-zinc-500 dark:text-zinc-400",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:border-purple-950 data-[state=active]:text-purple-950 dark:data-[state=active]:border-purple-50 dark:data-[state=active]:text-purple-50",
      className,
    )}
    {...props}
  />
